...
class EmailGenerator:
    ...
    def _build_system_prompt(self, email_type: str, custom_instructions: str = "") -> str:
...
"""
    ...
    def generate(self, email_type: str = "first_email", custom_instructions: str = "") -> dict:
        """
...
def generate_email_for_campaign(
    ...
    return generator.generate(email_type=email_type, custom_instructions=custom_instructions)
